    ...
    <div class="cj-container">
      ...
      <div class="consortium-section">
        ...
        <div class="consortium-items">
          <div class="row no-gutters">
            <?php
            while ($consorcium->have_posts()) : $consorcium->the_post();

              $custom_fields = get_post_custom(get_the_ID());
              $reference_label = $custom_fields['reference_label'][0];
              $reference = $custom_fields['reference'][0];
              ...
              <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="consortium-item flip-container">
                  <div class="flipper">
                    ...
                    <div class="back">
                      <h4 class="consortium-member-title"><?php the_title() ?></h4>
                      <p class="consortium-member-description"><?=wp_strip_all_tags( get_the_content() ) ?></p>
                      <a class="consortium-member-reference" href="<?=$reference?>"><?=$reference_label?></a>
                    </div>
                  </div>
                </div>
              </div>
