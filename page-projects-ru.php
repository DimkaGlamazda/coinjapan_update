<?php get_header() ?>
                ...
                <div class="row no-gutters achievements-row" data-projectsAutocount="container">
                    <div class="col-sm-12 col-md-4">
                        <div class="project-item">
                            ...
                            <p class="partners-number-medium"><span data-projectsAutocount="field" data-from="1" data-to="15">15</span></p>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <div class="project-item project-item-middle">
                            <h3><?php pll_e('Successful ICOs')?></h3>
                            <p><span class="success-ico-color partners-number-medium" data-projectsAutocount="field" data-from="2" data-to="15">15</span></p>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <div class="project-item">
                            <h3><?php pll_e('Collected funds')?></h3>
                            <p class="partners-number-medium">$<span data-projectsAutocount="field" data-from="100" data-to="400">400</span><span class="partner-number-description"><?php pll_e('Million')?></span></p>
                        </div>
                    </div>
                </div>
                <div class="row no-gutters achievements-row" data-projectsAutocount="container">
                    <div class="col-sm-12 col-md-4">
                        <div class="project-item ">
                            ...
                            <p class="partners-number-medium"><span data-projectsAutocount="field" data-from="400" data-to="3100">3100</span>+</p>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <div class="project-item project-item-middle">
                            <h3><?php pll_e('Average contribution of one investor')?></h3>
                            <p class="partners-number-medium">$<span  data-projectsAutocount="field" data-from="267" data-to="129">129</span><span class="partner-number-description"><?php pll_e('Thousand')?></span></p>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4">
                        <div class="project-item project-item-last">
                            <h3><?php pll_e('Average time to launching ICO')?></h3>
                            <p class="partners-number-medium"><span  data-projectsAutocount="field" data-from="1" data-to="3">3</span><span class="partner-number-description"><?php pll_e('Month')?></span></p>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <section class="projects-partners">
    ...
    <section class="clients-reviews">
        <div class="cj-container">
            <h2 class="section-header animated fadeInUp" data-css-animate="trigger"><?php pll_e('What our clients say')?></h2>
